...
local function get_c_file_for_youtube(c_file)
    local x = c_file:gsub("watch%?v=", "")
    return x
end
...
function M.exe()
    ...
    print("c_file:", c_file)
    if(is_youtube(c_path) == true) then
        x = get_c_file_for_youtube(c_file)
        print("x:", x)
        appdata = os.getenv("APPDATA")
        mk_path = appdata.."/mpv/youtube-bookmarks/"..x
    else
